...
class AnalysisResult(Base):
    ...
    stem_drums_s3_key = Column(String)
    stem_bass_s3_key = Column(String)
    stem_vocals_s3_key = Column(String)
    stem_other_s3_key = Column(String)
    stem_drum_low_s3_key = Column(String)
    stem_drum_mid_s3_key = Column(String)
    stem_drum_high_s3_key = Column(String)
